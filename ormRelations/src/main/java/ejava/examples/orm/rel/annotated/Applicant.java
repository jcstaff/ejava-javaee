...
/**
 * The class provides a set of OneToOne relationship examples. It contains 
 * a uni-directional, non-primary key relationship to Person and a 
 ...
 * $Id:$
 */
@Entity @Table(name="ORMCORE_APPLICANT")
