 ...
 * once one of the groups fails. This is also an example of a class where
 * we have overridden the Default group for the class to start with 
 * (what would normally be) the Default group and then continue to two 
 * other validations groups.
 */
@Entity
