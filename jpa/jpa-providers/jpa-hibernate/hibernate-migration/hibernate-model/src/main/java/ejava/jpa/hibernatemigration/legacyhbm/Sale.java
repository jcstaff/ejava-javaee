...
/**
 * This class provides an example legacy class that will use an external entity mapping. It acts as the 
 * inverse side of a One-to-Many, bi-directional relationship and the owning side of a Many-to-Many relationship.
 * It uses a manually generated Id, a date, and decimal value that should require some attention in the mapping.
 */
public class Sale {
	private String id;
