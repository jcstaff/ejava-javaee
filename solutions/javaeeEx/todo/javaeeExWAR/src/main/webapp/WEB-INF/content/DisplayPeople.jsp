...
<html>
    ...
    <body>
        ...
        <jsp:scriptlet>
            List people = (List)request.getAttribute("people");
        ...
        <ul>
            <jsp:scriptlet>
                for(Object o: people) {
                    ...
                    String url2 = "?id=" + p.getId() + "&command=Get+Person+Hydrated";
            </jsp:scriptlet>
                <li><a href="<%= url %>"><%= firstName %> <%= lastName %> </a>
                    (<a href="<%= url2 %>">hydrated</a>)
                </li>
        ...
        <form method="GET" 
            ...
            <input type="submit" name="command" value="Get People"/>
        </form>
